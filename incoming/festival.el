...
;;
;; $Log: festival.el,v $
;; Revision 1.3  1999/05/24 11:40:27  davep
;; Tidy-up for some doc strings.
;;
;; Revision 1.2  1999/05/23 06:21:53  davep
;; Changed `festival-send' to take a `format' string as its arguments.
;; Changed all calls to `festival-send' that used `format' to simply pass the
;; parameters to `festival-send'.
;;
;; Revision 1.1  1999/05/22 05:41:02  davep
;; Initial revision
;;
...
(defun festival-voice (voice-name)
  ...
  (interactive
   (list (completing-read "Voice: " festival-voices-alist nil t)))
