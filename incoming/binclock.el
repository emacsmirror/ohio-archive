...
;;
;; $Log: binclock.el,v $
;; Revision 1.6  1999/03/31 09:50:15  davep
;; Modified `binclock-time-bcd' to use `multiple-value-list' when calling
;; `cl-floor'.
;;
;; Revision 1.5  1999/03/14 15:20:15  davep
;; Fixed a couple of typos and spelling errors.
;;
;; Revision 1.4  1999/02/15 23:52:05  davep
;; Made some of the code slightly more "Common Lispish".
;;
;; Revision 1.3  1999/02/12 13:46:24  davep
;; Added test for availability of with-current-buffer. emacs 19.xx doesn't have
;; this.
;; Did some other tidying up of the code.
;;
;; Revision 1.2  1999/02/04 23:26:11  davep
;; Simplified `binclock-timer'.
;; Better tracking of the clock window. There is now much less chance of
;; multiple clock windows appearing.
;; Remove the "write-enable" macro.
;; Added lots more keystrokes to `binclock-mode'.
;; Added a clock menu.
;;
