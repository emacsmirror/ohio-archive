;;; pong.el v1.0 - classical implementation of pong
...
(defvar pong-xx nil "Horizontal speed of the ball")

(defvar pong-yy nil "Vertical speed of the ball")

(defvar pong-x nil "Horizontal position of the ball")

(defvar pong-y nil "Vertical position of the ball")

(defvar pong-bat-player1 nil "Vertical position of bat 1")

(defvar pong-bat-player2 nil "Vertical position of bat 2")
...
(defun pong-move-left ()
  "Move bat 2 up (this is called left for historical reasons, since in
some pong implementations you move with left/right paddle)"
  (interactive)
...
(defun pong-update-game (pong-buffer)
  "\"main\" function.  It is called every pong-cycle-delay seconds and
