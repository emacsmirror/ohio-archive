...
;; $Id: bibtex.el,v 1.33 2000/02/16 15:11:20 dirk Exp $
...
(defconst XEmacs?
  (string-match "[Xx][Ee][Mm][Aa][Ac][Ss]" (emacs-version)))
...
(if XEmacs?
    (defun bibtex-sit-for (seconds &optional nodisplay)
      (sit-for seconds nodisplay)) ; XEmacs usage
  (defun bibtex-sit-for (seconds &optional nodisplay)
    (sit-for seconds nil nodisplay))) ; Emacs usage
