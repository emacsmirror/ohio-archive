 ...
 * exceptions. Jump to
 * '{@link #doTraceExceptions trace_exceptions}',
...
public class SpecCommands extends ApplicationCommands {
     ...
     */
    public void doTraceExceptions(Integer cmd_id, List args)
	throws JDEException {
  ...
  private void clearPreviousStep(ThreadReference thread) {
    ...
    public SpecCommands(Application a, EventRequestSpecList e,
			      ObjectStore s) {
	super(a, s);
