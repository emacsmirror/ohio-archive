...
;; `region'                       `isearch'
;; `region'                       `zmacs-region'
;; `dired-face-boring'            `font-lock-string-face'
;; `dired-face-directory'	  `font-lock-function-name-face'
;; `dired-face-executable'	  `default'
;; `dired-face-flagged'		  `font-lock-warning-face'
;; `dired-face-marked'		  `font-lock-warning-face'
;; `dired-face-permissions'	  `default'
;; `dired-face-setuid'		  `default'
;; `dired-face-socket'		  `default'
;; `dired-face-symlink'		  `font-lock-keyword-face'
