; Path: dg-rtp!rock.concert.net!mcnc!stanford.edu!agate!ucbvax!van-bc!ubc-cs!unixg.ubc.ca!brazeau.ucs.ualberta.ca!alberta!cpsc.ucalgary.ca!krawchuk
; From: krawchuk@cpsc.UCalgary.ca (Bj Krawchuk)
; Newsgroups: gnu.emacs.sources
; Subject: gnus-hide.el 1.04
; Summary: a quote, signature and reference hider
; Date: 19 Jun 91 18:43:34 GMT
; Organization: The University of Calgary
; 
; 
; Here's a treat for GNUS users.
; It is a major enhancement of the old gnus-hide-quote.el.
; It does quote, signature and reference-line hiding.
; 
; Please tell me about any bugs (I know of a couple already)
; so that I can iron them out for the next version.
; This version should work for almost all articles, however.
; Also please offer suggestions (or code!) for future versions. 
; 
; Enjoy.
; 
...
;;;
;;; LCD Archive Entry:
;;; gnus-hide|Bj Krawchuk|krawchuk@cpsc.UCalgary.ca
;;; |A quote, signature and reference hider for the GNUS news reader
;;; |91-06-19|1.04|~/misc/gnus-hide.el.Z
;;;
...
(defun gnus-Article-is-followup ()
