...
;;; File:		profile.el
;;; Description:	Program to generate run time measurements of
;;;			elisp functions.
...
;; LCD Archive Entry:
;; profile|Boaz Ben-Zvi|boaz@lcs.mit.edu|
;; Program to generate run time measurements of elisp functions.|
;; 92-02-07|1.0|~/misc/profile.el.Z|
