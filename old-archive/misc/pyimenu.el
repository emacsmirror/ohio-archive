...
;; LCD Archive Entry:
;; pyimenu|Perry A. Stoll|stoll@atr-sw.atr.co.jp|
;; Python addition for imenu|
;; 17-Jul-1995|1.1|~/misc/pyimenu.el.gz|

(defconst pyimenu-version (substring "$Revision: 1.1 $" 11 -2)
  "$Id: pyimenu.el 1.1 1995/07/17 01:53:29 stoll Exp $

Report bugs to: Perry A. Stoll <stoll@atr-sw.atr.co.jp>")
...
;; use it to look at Python source. So here's a go at it.

;; The authors of imenu want to see the authors of modes add support
;; for imenu. Unfortunately, the python-mode author can not be
;; reached. In the mean time, this works.
...
;; which contains all methods. Selecting any item will bring you to
;; that point in the file. Optionally, function arguments may be
;; viewed in the imenu list.

;;}}}
;;{{{ Installation

;; You MUST have:
;;   python-mode.el - comes with the python distribution
;;   imenu.el - comes with emacs 19.xx 
;;             (1.11 through 1.14 are known to work)
...
;; 1.1  * require'd cl. necessary for push and pop.
;;      * changed some comments and added version info.
;;      * using folding mode.
...
;; while, I decided to dump it. This file is relatively self contained
