;;; From wjc@hos1cad.ATT.COM Fri May 24 13:28:58 1991
;;; Xref: cbnewsh gnu.emacs.sources:326 comp.emacs:6477
;;; Newsgroups: gnu.emacs.sources,comp.emacs
;;; Path: cbnewsh!hoswjc!wjc
;;; From: wjc@hos1cad.ATT.COM (Bill Carpenter)
;;; Subject: feedmail.el, patchlevel 2
;;; Organization: AT&T Bell Laboratories
;;; Date: Fri, 24 May 1991 17:23:50 GMT
;;; Message-ID: <1991May24.172350.25288@cbnewsh.att.com>
;;; References: <1991Mar31.011705.9965@cbnewsh.att.com>
;;; 	<1991Apr5.135249.3249@cbnewsh.att.com>
;;; Sender: bill@cbnewsh.att.com (william.j.carpenter)
;;; Lines: 481
;;; 
...
(defun feedmail-send-it ()
  (let* ((default-case-fold-search t)
    ...
    (unwind-protect (save-excursion
		...
		(if mail-aliases (expand-mail-aliases (point-min) end-of-headers-marker))
