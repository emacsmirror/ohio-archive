...
;; $Id: webster.el,v 1.2 1995/01/04 00:41:51 friedman Exp $
;; LCD Archive Entry:
;; webster|Noah Friedman|friedman@gnu.ai.mit.edu|
;; emacs interface to webster servers|
;; 04-Jan-1995|1.2|~/interfaces/webster.el.gz|
...

;;;###autoload
(defvar webster-server "localhost"
...
(defun webster-send (request word)
  ...
  (cond
   ((null webster-process)
    (webster-start))
   ((and (eq (process-status webster-process) 'open)
