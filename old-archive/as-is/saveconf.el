...
;Date: Wed, 3 May 89 16:08:57 edt
;From: talos!kjones@uunet.uu.net (Kyle Jones)
;To: info-gnu-emacs@prep.ai.mit.edu
;Subject: saveconf.el
;
;This is the latest version of the Emacs Lisp library saveconf.el.
;Replace the lisp/saveconf.el file in the Emacs distribution with this
;version.
;
