...
;Date: 31 Oct 88 11:50:10 GMT
;From: John Sturdy <mcvax!ukc!eagle.ukc.ac.uk!icdoc!qmc-cs!harlqn!jcgs@uunet.uu.net>
;Subject: makefile mode
;
;Here is a simple makefile mode for GNUemacs. Most of it is concerned
;with completion on target and macro names, and inserting the names with
;the correct syntax. A lot could be added to it! In particular, a
;version of M-x compile which reads its argument with a completing-read
;on targets would be nice.
;The indentation function could certainly be improved.
;------------------------------ cut here for makefile.el ----------------
