...
;;;From: jason@SSD.HARRIS.COM (Jason Baietto)
;;;Subject: Re: Insert Variable Dump (the poor person's debugger)
;;;Date: 21 Nov 89 17:23:55 GMT

;;;Oops!  There should be another define-key:

(define-key global-map "\C-cp" 'insert-printf-statement)

;;;Of cousre, you'll probably want to change the bindings anyway, but...
;;;Hope this was the only omission.
