...
;;;
;;;  $Id: nuweb.el,v 1.103 1994/08/10 14:19:05 ddw2 Exp $ 
;;;
;;;
;; LCD Archive Entry:
;; nuweb|Dominique de Waleffe|ddw@sunbim.be|
;; Major mode to edit nuweb files with AucTex|
;; 10-Aug-1994|1.103|~/modes/nuweb.el.Z|
;;
;;
...
;;
;; DISCLAIMER: BIM sa  does not guarantee anything about this
;; package, nor do I. You get it as is and not much else.
;;
