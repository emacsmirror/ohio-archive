...
(defun word-thing-validify-word ()
 ...
 y  all words at least 3 letters long
 y  attaches to another word or on the ** square
 y  is a valid word
 y  doesn't make neighboring invalid words"
...
(defun word-thing-spell (test)
  "Check to see if TEST is a valid word.  Uses spell-string and a
special two letter word checker."
