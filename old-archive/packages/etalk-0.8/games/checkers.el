...
(defvar checkers-black-cell '("black" . "gray")
  "Color of black cell background")

(defvar checkers-red-background "orangered3"
  "Color behind peices")

(defvar checkers-player1-color "black"
  "Color for player1")

(defvar checkers-player2-color "white"
  "color for player2")

;;; If we have a window system, load in cool colors to use on the game board
(if (and game-lib-use-colors window-system)
    (progn
      (copy-face 'default 'checkers-black-face)
      (set-face-foreground 'checkers-black-face (cdr checkers-black-cell))
      (set-face-background 'checkers-black-face (car checkers-black-cell))

      (copy-face 'default 'checkers-player1-face)
      (set-face-foreground 'checkers-player1-face checkers-player1-color)
      (set-face-background 'checkers-player1-face checkers-red-background)
      (make-face-bold 'checkers-player1-face)

      (copy-face 'default 'checkers-player2-face)
      (set-face-foreground 'checkers-player2-face checkers-player2-color)
      (set-face-background 'checkers-player2-face checkers-red-background)
      (make-face-bold 'checkers-player2-face)
      ))
