;;; -*-Emacs-Lisp-*-
;;; $Id: ilisp-def.el,v 1.15 1993/06/29 06:13:12 ivan Rel $
;;;%Header
...
(defvar ilisp-bugs-to "ilisp-bugs@darwin.bu.edu" "Who to send bug reports to.")
...
(defvar ilisp-version "5.3" "Interface version.")
