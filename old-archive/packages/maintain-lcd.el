...
;; RCSID           : $Header$
;; Author          : David Brennan (brennan@rtp.dg.com)
;; Created On      : Sat Dec 15 16:31:41 1990
;; Last Modified By: David Brennan
;; Last Modified On: Wed Aug  7 18:34:28 1991
;; Update Count    : 61
;; Status          : Pretty good...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;; LCD Archive Entry:
;; maintain-lcd|David Brennan|brennan@rtp.dg.com
;; |Useful functions for LCD maintaince work
;; |91-07-24|2.11|~/misc/maintain-lcd.el|
...
(defvar lcd-working-directory "/usr/local/lib/emacs/archive/"
...
(defvar lcd-datafile (concat lcd-working-directory "LCD-datafile")
...
the point at the start of the line containing the entry."
  ...
  (if (re-search-forward lcd-entry-marker nil t)
	...
	(save-excursion
	  (if (not (search-forward "|" nil 'no-error 7))
	      (message "Badly formatted LCD Archive Entry!"))
	  (forward-line 1)
	  (beginning-of-line)
