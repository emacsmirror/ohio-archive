;From utkcs2!emory!swrinde!zaphod.mps.ohio-state.edu!usc!elroy.jpl.nasa.gov!cit-vax!daveg Tue Jun 12 10:08:45 EDT 1990
;Article 4426 of comp.emacs:
;Xref: utkcs2 gnu.emacs:2948 comp.emacs:4426
;Path: utkcs2!emory!swrinde!zaphod.mps.ohio-state.edu!usc!elroy.jpl.nasa.gov!cit-vax!daveg
;>From: daveg@cit-vax.Caltech.Edu (David Gillespie)
;Newsgroups: gnu.emacs,comp.emacs
;Subject: Keyboard macro editor
;Message-ID: <15241@cit-vax.Caltech.Edu>
;Date: 11 Jun 90 22:44:48 GMT
;Reply-To: daveg@cit-vax.UUCP (David Gillespie)
;Organization: California Institute of Technology
;Lines: 628
;
;The recent posting of my GNU Emacs calculator on comp.sources.misc omitted
;the file "macedit.el".  For your keyboard-macro-programming enjoyment,
;here it is now.
;
;MacEdit is not directly related to Calc---anybody who uses keyboard macros
;in Emacs can use MacEdit.
;
;								-- Dave
