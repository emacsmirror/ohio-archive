...
(define-key gnus-summary-mode-map "\C-cr" 'gnus-summary-simplify-references)
...
(defvar gnus-hide-overload-functions
  '((mail-yank-original       	 sc-mail-yank-original) 
    (gnus-summary-save-in-rmail  gnus-hide-Subject-save-in-rmail)
    (gnus-summary-save-in-mail 	 gnus-hide-Subject-save-in-mail)
    (gnus-summary-save-in-file 	 gnus-hide-Subject-save-in-file)
    (gnus-summary-save-in-folder gnus-hide-Subject-save-in-folder)
    )
