...
;;; $Id: dbfrobs.el,v 1.5 1995/11/12 21:09:24 friedman Rel $

;;; LCD Archive Entry:
;;; dbfrobs|Noah Friedman|friedman@gnu.ai.mit.edu|
;;; useful enhancements for debugging|
;;; 12-Nov-1995|1.5|~/functions/dbfrobs.el.gz|
...
;; XEmacs 19.12 and earlier do not have eval-after-load or load-history.
    ...
    (if node
        (while forms
          (or (member (car forms) (cdr node))
              (setcdr node (cons (car forms) (cdr node))))
