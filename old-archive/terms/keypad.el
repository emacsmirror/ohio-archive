;;; File:  keypad.el, v 2.0 (emacs 18[.58] version)

;; Copyright (C) 1993 Jeff Morgenthaler
;; Copyright (C) 1986 Free Software Foundation, Inc.

;; LCD Archive Entry:
;; keypad.el|Jeff Morgenthaler|jpmorgen@wisp4.physics.wisc.edu|
;; Support for all the function keys of the vt200 (LK105) keyboard|
;; 22-Mar-1993|2.9|~/terms/keypad.el|
...
;; New--makes "Do" into M-x
(keypad-default "x" 'execute-extended-command)
...
;; New stuff.
(keypad-default "\C-l" 'fill-paragraph)
(keypad-default "\C-m" 'fill-region)
(keypad-default "\C-n" 'set-fill-prefix)
