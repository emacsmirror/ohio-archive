;;; File:  flow-ctrl.el, v 3.2 (emacs 18/19 version)
;;;
;;;               -------   -------------   ---------------------
...
;; LCD Archive Entry:
;; flow-ctrl.el|Jeff Morgenthaler|jpmorgen@wisp4.physics.wisc.edu|
;; A better wrapper for remapping C-s and C-q for XON-XOFF hobbled terms.|
;; 09-Jun-1993|3.2|~/terms/flow-ctrl.el.Z|
...
;;;; To make this facility available to all users, place this file
